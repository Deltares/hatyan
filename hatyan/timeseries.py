...
def calc_HWLWnumbering(ts_ext, station=None):
    ...
    if station is None:
        ...
        print(f'no value or None for argument M2phasediff provided, automatically calculated correction w.r.t. Cadzand is {M2phasediff_hr:.2f} hours ({M2phasediff_deg:.2f} degrees)')
    else:
