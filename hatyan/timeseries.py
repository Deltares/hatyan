...
def calc_HWLWnumbering(ts_ext, station=None, mode='M2phase',doHWLWcheck=True):
    ...
    if station is None:
        if mode=='M2phase':
            ...
            comp_M2 = analysis(ts_ext,const_list=['M2'],xTxmat_condition_max=150) #high condition value, since it should provide a phasediff also in case of only one HW+LW
