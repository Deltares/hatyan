...
for fu_alltimes in [True,False]:
    const_list = get_const_list_hatyan('springneap')
    ...
    #ts_measurements_group0 = Timeseries.crop_timeseries(ts_measurements_group0, times_ext=[dt.datetime(2012,1,1),dt.datetime(2012,2,1)])
    ...
    #COMP_merged = get_components_from_ts(ts=ts_measurements_group0, const_list=const_list, fu_alltimes=True)
    COMP_merged_xfac0 = analysis(ts=ts_measurements_group0, const_list=const_list, fu_alltimes=fu_alltimes, xfac=False)#, return_prediction=True)
    COMP_merged_xfac1 = analysis(ts=ts_measurements_group0, const_list=const_list, fu_alltimes=fu_alltimes, xfac=True)#, return_prediction=True)
    print(COMP_merged_xfac0)
    print(COMP_merged_xfac1)
    #fig, (ax1,ax2) = Timeseries.plot_timeseries(ts=ts_predCOMPyear, ts_validation=ts_measurements_group0)
    ...
    #ts_prediction = prediction(comp=COMP_merged, fu_alltimes=True, times_ext=times_ext_pred, timestep_min=times_step_pred)
    ts_prediction_xfac0_xfac0 = prediction(comp=COMP_merged_xfac0, fu_alltimes=fu_alltimes, xfac=False, times_ext=times_ext_pred, timestep_min=times_step_pred)
    ts_prediction_xfac0_xfac1 = prediction(comp=COMP_merged_xfac0, fu_alltimes=fu_alltimes, xfac=True, times_ext=times_ext_pred, timestep_min=times_step_pred)
    ts_prediction_xfac1_xfac0 = prediction(comp=COMP_merged_xfac1, fu_alltimes=fu_alltimes, xfac=False, times_ext=times_ext_pred, timestep_min=times_step_pred)
    ts_prediction_xfac1_xfac1 = prediction(comp=COMP_merged_xfac1, fu_alltimes=fu_alltimes, xfac=True, times_ext=times_ext_pred, timestep_min=times_step_pred)
    ...
    fig, (ax1,ax2) = Timeseries.plot_timeseries(ts=ts_prediction_xfac0_xfac0, ts_validation=ts_prediction_xfac1_xfac1)
    fig.savefig(os.path.join(dir_output,'fualltimes%d_anaxfac0_predxfac1.png'%(fu_alltimes)))
    fig, (ax1,ax2) = Timeseries.plot_timeseries(ts=ts_prediction_xfac1_xfac1, ts_validation=ts_prediction_xfac0_xfac0)
    fig.savefig(os.path.join(dir_output,'fualltimes%d_anaxfac1_predxfac0.png'%(fu_alltimes)))
    fig, (ax1,ax2) = Timeseries.plot_timeseries(ts=ts_prediction_xfac0_xfac0, ts_validation=ts_prediction_xfac0_xfac1)
    fig.savefig(os.path.join(dir_output,'fualltimes%d_anaxfac0_predxfacdiff.png'%(fu_alltimes)))
    fig, (ax1,ax2) = Timeseries.plot_timeseries(ts=ts_prediction_xfac1_xfac0, ts_validation=ts_prediction_xfac1_xfac1)
    fig.savefig(os.path.join(dir_output,'fualltimes%d_anaxfac1_predxfacdiff.png'%(fu_alltimes)))
    fig, (ax1,ax2) = Timeseries.plot_timeseries(ts=ts_prediction_xfac0_xfac0, ts_validation=ts_prediction_xfac1_xfac0)
    fig.savefig(os.path.join(dir_output,'fualltimes%d_anaxfacdiff_predxfac0.png'%(fu_alltimes)))
    fig, (ax1,ax2) = Timeseries.plot_timeseries(ts=ts_prediction_xfac0_xfac1, ts_validation=ts_prediction_xfac1_xfac1)
