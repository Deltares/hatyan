...
for current_station in selected_stations:
    ...
    settings = hatyan.HatyanSettings(nodalfactors=True, fu_alltimes=False, xfac=True,
                                     analysis_peryear=True, return_allyears=True, source='schureman') #schureman takes 2seconds, foreman takes 8 seconds
    #constituent list
    ...
    comp_frommeasurements_avg_group0, comp_frommeasurements_all_group0 = hatyan.get_components_from_ts(ts=ts_measurements_group0, const_list=const_list, hatyan_settings=settings)
